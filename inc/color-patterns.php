 ...
 */
function wuchaiwp_custom_colors_css() {
	 ...
	 */
	$saturation         = absint( apply_filters( 'wuchaiwp_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.wuchaiwp-front-page) .entry-title,
...
.colors-custom .wuchaiwp-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.wuchaiwp-front-page .panel-content .recent-posts article,
...
.colors-custom.wuchaiwp-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'wuchaiwp_custom_colors_css', $css, $hue, $saturation );
}
